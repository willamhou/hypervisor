...
| 顺序 | 文章 | 文件 | 选位理由 |
|---|---|---|---|
| 1 | pKVM 完全解析 | `pkvm-explainer.md` | 科普换节奏,给"两个 hypervisor"主题补背景 |
| 2 | Part 0b — AI 工作流篇 | `part0b-ai-workflow.md` | meta 反思,与 part0a 同系列收尾 |
| 3 | 实战记 — 真 ARM 跑通完整 NS→Secure 链 | `e2e-on-arm-fieldnotes.md` | 最新一手战报,收官 |
