---
layout: default
title: "你的 Android 手机里藏着一个 Hypervisor：pKVM 完全解析"
description: "pKVM 是什么、为什么需要它、它怎么工作，以及它和 TrustZone 的关系"
---

[← Back to main blog](index.md) \| [View on GitHub](https://github.com/willamhou/hypervisor)
...
- 据 Google 称，这是首个面向消费电子大规模部署且达到此级别的软件系统
...
- **代码**：[github.com/willamhou/hypervisor](https://github.com/willamhou/hypervisor)
- **详细博客**：[Two Hypervisors, One SoC](index.md)
